...
{
	/*
	Pedro trabalha sempre até tarde todos os dias, com isso tem pouco tempo para as tarefas domésticas.
	...
	*/
	...
	public static void Main(string[] args)
	{
		...
		{
			var listaDeCompras = Console.ReadLine().Split(' ');

			var listaDeComprasOrdenada = listaDeCompras.Distinct().OrderBy(x => x).ToList();

			Console.WriteLine(string.Join(" ", listaDeComprasOrdenada));
		}
